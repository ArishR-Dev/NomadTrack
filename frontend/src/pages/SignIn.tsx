...
export default function SignIn() {
  ...
  useEffect(() => {
    ...
    if (error) {
      const msg = error === "access_denied" ? "Google sign-in was cancelled." : error === "google_not_configured" ? "Google sign-in is not configured." : "Sign-in failed. Try again.";
      toast.error(msg);
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Sign in to your NomadTrack account</p>
        </div>
